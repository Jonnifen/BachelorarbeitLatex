...
XPath wird hauptsächlich in der Transformationssprache \ac{XSLT} eingesetzt, welche XML-Dateien in ander Datenformate umwandeln soll.
...
Knoten beschreiben Teile des XML-Dokumentes können, aber auch über das Wurzelknoten das gesamte Dokument beschreiben.
