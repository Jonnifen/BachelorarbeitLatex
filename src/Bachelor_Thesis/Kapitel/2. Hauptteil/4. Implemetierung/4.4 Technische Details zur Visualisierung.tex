...
\begin{enumerate}
    ...
    In dieser werden die geordneten Datensätze mit Hilfe der JavaScript-Dateien \code{dut\_plot.js} und \code{plotly-latest.min.js} verarbeitet und die Grafen für die Analyse-Seite erstellt und ausgegeben.
